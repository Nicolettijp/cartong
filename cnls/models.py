...
class Action(models.Model):
    ...
    echelle_localisation = models.CharField(max_length=10,choices=REGION_STATUS, verbose_name="Echelle nationale?")
...
class ActionLocalisation(models.Model):
    ...
    action = models.ForeignKey(Action)
    region_status =  models.CharField(max_length=10,choices=ECHELLE_LOCALISATION,  verbose_name="Définir la localisation de l'action ?")
    #!!! if selon la valeur de 'region_status', le champs correspondant se rempli automatiquement. !!!
    choix_status = models.CharField(max_length = 50,blank=True, null=True,verbose_name="limite choisie")
